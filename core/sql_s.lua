...
function Sql:update(tbl, update, where, callback)
	...
	self:query(str:sub(1,-3)..w, callback)
end
...
--connection:createTable('accounts',{id='INT AUTO_INCREMENT PRIMARY KEY', serial='varchar(255) NOT NULL UNIQUE', name='varchar(255)', intId='INT', dim='INT', pos='varchar(255)', skin='INT'})
--[[
...
--connection:insert('users', {serial='521',name='sarah',age=12})
--connection:update('users', {serial='222', age=23, name='stone'}, {serial='521'})


--connection:createTable('accounts', {id='int auto_increment primary key', serial='text', name='text', pos='text', skinId='int'})]
